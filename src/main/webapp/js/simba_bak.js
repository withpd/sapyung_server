...
// Set the indicator
moveIndicator(pnProductNav.querySelector("[aria-selected=\"true\"]"), main_color);
...
pnProductNavContents.addEventListener("click", function(e) {
	...
	moveIndicator(e.target, main_color);
});
...
function binding_page(page) {
	prev_page=page;
	if(prev_page != 'index.html') {
		$("#section_home").load(prev_page);
	}
}

function addElement(item) {
//	 var imgList = item[0].imgUrl;
//	 var colorList = item[1].color;
//	 var sizeList = item[2].size;
//   	var price = item[3].price;
//   	var title = item[4].title;
//   	var url = item[5].url;
...
//    imgElement.src = "img/logo1.png";
    ...
    imgElement.addEventListener("click", function() {
    	// clearElement();
    	$("#section_home").load("detail.html");
    });
    figureElement.appendChild(imgElement);
    figureElement.appendChild(figcaptionElement);
    rootDiv.appendChild(figureElement);
//    console.log(rootDiv.childNodes.length-1);
//    document.body.appendChild(rootDiv);

    //document.getElementById("div_loader").reload(true);
}
